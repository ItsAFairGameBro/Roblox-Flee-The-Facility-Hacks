...
local function StartBetterConsole()
	...
	local function BetterConsole_SetMessagesVisibility(MessageLabel)
		...
		SearchConsoleResults.Text = (includeALL or total==0) and "" 
			or '<font color="rgb(0,255,0)">'..comma_value(visibleMessages) ..`</font> search result{current>1 and 's' or ''} for found "`..C.ApplyRichTextEscapeCharacters(currentText,true)..'"'
